...
//        });
    ...
    public String report() {
        ...
        sb.append(String.format("%d presents are done!",presentCount)).append(System.lineSeparator())
        ...
        helperRepository.getModels().stream().map(h -> sb.append(String.format("Name: %s",h.getName()))
                ...
                .append(System.lineSeparator())
                .append(String.format("Instruments: %s not broken left%n",h.getInstruments()
                .stream().filter(instrument -> !instrument.isBroken()).count())))
